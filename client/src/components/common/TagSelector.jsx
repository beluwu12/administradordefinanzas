/**
 * TagSelector Component - Refactored with Design System
 */
...
const tagIcons = {
    'comida': 'restaurant', 'food': 'restaurant',
    'transporte': 'directions_car', 'transport': 'directions_car',
    'compras': 'shopping_bag', 'shopping': 'shopping_bag',
    'ocio': 'movie', 'entertainment': 'movie',
    'vivienda': 'cottage', 'housing': 'cottage',
    'servicios': 'bolt', 'utilities': 'bolt',
    'salud': 'health_and_safety', 'health': 'health_and_safety',
    'educacion': 'school', 'education': 'school',
    'default': 'sell'
};
...
export default function TagSelector({ availableTags, selectedTags, onToggleTag, onTagCreated }) {
